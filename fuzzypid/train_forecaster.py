# hospital_fuzzypid/train_forecaster.py
...
def train_model():
    ...
    torch.save(model.state_dict(), 'hospital_fuzzypid/forecast_model.pth')
    joblib.dump((scaler_X, scaler_y), 'hospital_fuzzypid/scalers.pkl')
